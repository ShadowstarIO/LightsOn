...
Early source. Not in the Dalamud plugin installer yet. Occupancy API is a Cloudflare Worker in [`worker/`](worker/), deployed by GitHub Actions. After the first deploy, the URL is `https://REDACTED` — paste that origin into plugin Settings.
