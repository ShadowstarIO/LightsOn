...
public sealed class Plugin : IDalamudPlugin
{
    ...
    public const string Version = "0.0.4.15";
    ...
    public Plugin()
    {
        ...
        {
            Configuration.ReportOptIn = true;
            if (Configuration.ReportEnabledAtUnix <= 0)
                Configuration.ReportEnabledAtUnix = DateTimeOffset.UtcNow.ToUnixTimeSeconds();
            Configuration.AutoHappening = false;
        ...
        http.DefaultRequestHeaders.UserAgent.ParseAdd("LightsOn/0.0.4.15 (+https://github.com/ShadowstarIO/LightsOn)");
